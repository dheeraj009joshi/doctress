class ServiceProvider:
    def __init__(self, username, email, password, profile_image, age, gender, phone, address, about, city, state, country, adhar_card, company_name, company_address, account_status="pending", membership=0, tickets=None, membership_trx=None, all_trx=None):
        ...
        self.membership_trx = membership_trx if membership_trx is not None else {"trx_id": "", "trx_amount": ""}
    ...
    def from_dict(service_dict):
        return ServiceProvider(
            ...
            service_dict.get('membership_trx', {"trx_id": "", "trx_amount": ""}),
